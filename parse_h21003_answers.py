...
def parse_h21003_answers(html_file, section_type):
    """Parse answers from H21003 HTML"""
...
def update_json(listening_answers, reading_answers):
    """Update H21003_complete.json with answers"""
    ...
    with open('H21003_complete.json', 'w', encoding='utf-8') as f:
        json.dump(exam, f, ensure_ascii=False, indent=2)
    
    print(f"\n✅ Updated {updated} answers in H21003_complete.json")

if __name__ == "__main__":
    print("="*60)
    print("H21003 Answer Parser")
    print("="*60)
    print()
    print("⚠️  Instructions:")
    print("1. Go to: https://mandarinbean.com/h21003-listening/")
    print("2. Click 'View Result' button")
    print("3. Save page as: H21003 Listening - Mandarin Bean.html")
    print()
    print("4. Go to: https://mandarinbean.com/h21003-reading/")
    print("5. Click 'View Result' button")
    print("6. Save page as: H21003 Reading - Mandarin Bean.html")
    print()
    print("7. Run this script again")
    print("="*60)
    
    import os
    listening_file = "H21003 Listening - Mandarin Bean.html"
    reading_file = "H21003 Reading - Mandarin Bean.html"
    
    if os.path.exists(listening_file) and os.path.exists(reading_file):
        print("\n✅ Found HTML files, parsing...\n")
        
        listening_ans = parse_h21003_answers(listening_file, 'listening')
        print(f"\nListening: {len(listening_ans)} answers")
        
        reading_ans = parse_h21003_answers(reading_file, 'reading')
        print(f"Reading: {len(reading_ans)} answers")
        
        update_json(listening_ans, reading_ans)
        
        print("\n🎉 Done! Check H21003_complete.json")
    else:
